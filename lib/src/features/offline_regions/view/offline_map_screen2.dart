...
class OfflineMapScreen2 extends StatefulWidget {
  const OfflineMapScreen2({
    super.key,
  });

  @override
  State<OfflineMapScreen2> createState() => _OfflineMapScreen2State();
}

class _OfflineMapScreen2State extends State<OfflineMapScreen2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, String>?>(
        future: GetIt.instance<StoreService2>().getBaseMapStore == null
            ? Future.sync(() => {})
            : FMTC.instance(baseMapStoreData['storeName']!).metadata.readAsync,
        builder: (context, metadata) {
          if (!metadata.hasData ||
              metadata.data == null ||
              (GetIt.instance<StoreService2>().getBaseMapStore != null && (metadata.data ?? {}).isEmpty)) {
            return const CircularProgressIndicator();
          }

          final String urlTemplate = GetIt.instance<StoreService2>().getBaseMapStore != null && metadata.data != null
                    ...
                    return FlutterMap(
                      ...
                      children: [
                        ...
                        TileLayer(
                          ...
                          tileProvider: GetIt.instance<StoreService2>().getBaseMapStore != null
                        ...
                        if (mapUIBloc.enableBathyMetry == true &&
                            GetIt.instance<StoreService2>().bathymetryLayerStore != null)
                          TileLayer(
                            backgroundColor: Colors.transparent,

                            urlTemplate: bathyMapStoreData['sourceURL'],
                            tileProvider: GetIt.instance<StoreService2>().bathymetryLayerStore != null
