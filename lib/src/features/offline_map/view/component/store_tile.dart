...
import 'package:flutter_map_offline_poc/src/features/offline_map/view/component/stats.dart';
import 'package:flutter_map_offline_poc/src/services/vars.dart';
...
class _StoreTileState extends State<StoreTile> {
  ...
  late final _store = FMTC.instance(widget.store.storeName);
  ...
  List<FutureBuilder<String>> get stats => [
        FutureBuilder<String>(
          ...
          builder: (context, snapshot) => StatDisplay(
            statistic: snapshot.connectionState != ConnectionState.done ? null : snapshot.data,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: _exportingProgress
                                ...
                                : () async {
                                    ...
                                    final bool result = await _store.export.withGUI(context: context);
                                    setState(
                          ...
                          //       builder: (BuildContext context) => StoreEditorPopup(
